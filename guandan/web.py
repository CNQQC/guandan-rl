...
class TrainOverrides(BaseModel):
    ...
    pool_recent: int | None = Field(default=None, ge=1, le=256)
    pool_archive_every: int | None = Field(default=None, ge=1, le=100_000)
    gate_threshold: float | None = Field(default=None, gt=0, lt=1)
